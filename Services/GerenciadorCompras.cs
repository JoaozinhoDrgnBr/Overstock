...
public class GerenciadorCompras
{
    ...
    public void adicionarCompra()
    {
        ...
        CompraRepository controller = new CompraRepository();
    ...
    public void adicionarItemCompra()
    {
        ...
        CompraRepository controller = new CompraRepository();
        CompraProdutoRepository controllerComProd = new CompraProdutoRepository();
    ...
    public void removerItemCompra()
    {
        ...
        foreach(var CompraId in compraProdutos)
        {
            ...
            {
                cont++;
                var produto = controllerProdutoRepository.ObterPorId(CompraId.ProdutoId);
